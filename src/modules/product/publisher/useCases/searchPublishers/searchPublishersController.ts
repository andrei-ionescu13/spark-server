...
export class SearchPublishersController extends Controller {
  constructor(private useCase: SearchPublishersUseCase) {
    super();
  ...
  executeImpl = async (req: Request, res: Response) => {
    ...
    const dto: SearchPublishersRequestDto = result.data;
