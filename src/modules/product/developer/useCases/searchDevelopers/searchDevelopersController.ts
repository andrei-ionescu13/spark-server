...
export class SearchDevelopersController extends Controller {
  constructor(private useCase: SearchDevelopersUseCase) {
    super();
  ...
  executeImpl = async (req: Request, res: Response) => {
    ...
    const dto: SearchDevelopersRequestDto = result.data;
