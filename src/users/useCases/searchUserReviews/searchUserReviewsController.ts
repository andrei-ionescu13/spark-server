...
export class SearchUserReviewsController extends BaseController {
  constructor(private useCase: SearchUserReviewsUseCase) {
    super();
  ...
  executeImpl = async (req: Request, res: Response) => {
    ...
    const dto: SearchUserReviewsRequestDto = {
