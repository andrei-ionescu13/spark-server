...
interface PublisherCreateProps extends Omit<PublisherProps, 'slug' | 'updatedAt'> {
  slug?: string;
  updatedAt?: Date | null;
}
...
export class Publisher {
  ...
  public static create(props: PublisherCreateProps): Result<Publisher, DomainValidationError> {
