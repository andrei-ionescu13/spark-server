...
import { getPlatformController } from './useCases/getPlatform/index';
import { listPlatformsController } from './useCases/listPlatforms';
...
router.get('/:platformId', (req: Request, res: Response) =>
  getPlatformController.execute(req, res),
);
