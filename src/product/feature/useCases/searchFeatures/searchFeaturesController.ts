...
export class SearchFeatureController extends Controller {
  constructor(private useCase: SearchFeaturesUseCase) {
    super();
  ...
  executeImpl = async (req: Request, res: Response) => {
    ...
    const dto: SearchFeaturesRequestDto = result.data;
